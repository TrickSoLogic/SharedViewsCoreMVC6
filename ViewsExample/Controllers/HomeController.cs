...
using SharedViewsCoreMVC6.Models;
...
namespace SharedViewsCoreMVC6.Controllers
{
  public class HomeController : Controller
  {
    ...
    public IActionResult Index()
    {
      ...
      {
          new Person() { Name = "Black", DateOfBirth = DateTime.Parse("2000-05-06"), PersonGender = Gender.Male},
          new Person() { Name = "Coder", DateOfBirth = DateTime.Parse("2005-01-09"), PersonGender = Gender.Female},
          new Person() { Name = "TrickSoLogic", DateOfBirth = null, PersonGender = Gender.Other}
      };
